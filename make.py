...
if __name__ == '__main__':
    ...
    for k, image_path in enumerate(image_list):
        ...
        print("asdaddadsadsadsadsad")
        print(image_list)
        print(image_path)

        bboxes, polys, score_text = craft_net(net, image, args.text_threshold, args.link_threshold, args.low_text, args.cuda, args.poly, refine_net)
        ...
        for i, box in enumerate(polys):
            ...
            cv2.imwrite('./cropdata/{}.jpg'.format(str(i)), img_trim)
